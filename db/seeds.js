...
const Hawaii = new Coffee({
	...
	description:'Hawaiian Kona coffee is known for its simple yet rich flavor, typically light, delicate and mild with a complex aroma and taste. A good Kona coffee is clean and well-balanced with a medium body and cheerful, bright acidity yet classically balanced and often exhibiting spicy and also buttery qualities with subtle winey tones, intensely aromatic, and with a great aftertaste/finish. The finer Kona coffees are purchased from single estates rather than a mix of Kona coffees pooled for general market sale.',
...
const Guatemala = new Coffee({
	...
	description: 'Antigua - The volcanic soil helps lock in moisture, as the region is sunnier and tends to get less rainfall than elsewhere, and the coffees are sweet, smooth, and good for blending or as mild, lower-acid single-origin offerings.
	...
	Huehuetenango - probably the most famous (and difficult to pronounce—it is generally said “way-way-ten-AN-go”). Crisp malic and citrus acidity, full body, and toffee sweetness mark these coffees, which tend to be the most fruit-forward and can be the most complex of what Guatemala has to offer.
	Nuevo Oriente -  a small region to the eastern edge of the country, butting up against the Honduran border. Its climate is cloudier and rainier than some of the other regions, and the relatively stable temperatures and limited sunlight create a full-bodied coffee with loads of balance.',
...
const Honduras = new Coffee({
	...
	description: 'Coffees from Honduras are fairly standard as far as Central American coffee ratings go, on equal footing with Guatemala, El Salvador and Nicaragua. Depending on the region they’re from and the varietal, they will have certain nuances and flavors that are more prominent in some tastes than others.
...
const Panama = new Coffee({
	...
	description: "Panamanian coffee is typically of the Geisha variety. Geisah coffee plants are known for producing coffee of  light body, bright acidity and jasmine-like aroma with honey and citrus tastes creating an outstanding cup character and profile.",
...
const Ecuador = new Coffee({
	...
	description: "Ecuadorian coffees tend to be somewhat acidic with a medium body and a predictable flavor typical of South American coffees and Central American coffees coffees.",
...
const Kenya = new Coffee({
	...
	description: 'Known for their potent sweetness and powerful character, Kenyan coffee tasting notes indicate it has a resonant cup presence, exhibiting intense flavors with a distinct winey richness and dry, winey aftertaste similar to Ethiopian Harrar yet with more of a full-bodied richness than Ethiopian coffees.',
...
const Tanzania = new Coffee({
	...
	description: 'Tanzania is known for a particular type of coffee bean, peaberry, that results from the cherry of the coffee plant containing just a single round bean rather than 2 flat-sided half beans. Many believe this produces an enhanced flavor.',
...
const Congo = new Coffee({
	...
	region: 'Africa',
	country: 'Congo',
	imgUrl: 'https://images.cafeimports.com/26202-drcongospecialtycoffeeregionsmap.png',
	description: 'The potential for quality coffee is high, but the political turmoil and power struggles there make stable business practices a huge challenge. ',
...
const Uganda = new Coffee({
	...
	region: 'Africa',
	country: 'Uganda',
	imgUrl: 'http://kyagalanyi.co.ug/wp-content/uploads/2014/05/2014-Uganda-coffee-map-+-KCL-sust-coffee-schemes.jpg',
	description: "A good brewed cup of Bugisu coffee exhibits cupping notes similar to the winey acidity of a fine East African coffee, with sweet chocolate flavor and rich texture. Generally speaking, the lower complexity and lighter body of Ugandan coffees makes them generally less distinguished than the finer coffees of neighboring Zimbabwe, Tanzania, or Kenya.
...
const Burundi = new Coffee({
	...
	description: "A fine Burundi single origin coffee exhibits a clean, delicate flavor with a rich body and acidity according to cupping notes. Coffee reviews indicate that that Burundi coffees have a sweet berry tastes floral notes and berry-like aromas.",
...
const Cameroon = new Coffee({
	...
	country: 'Cameroon',
	imgUrl: 'http://1.bp.blogspot.com/-xw16IsWBOmA/UyhSN_RAmyI/AAAAAAAAVOk/6drdzuCzkhc/s1600/map_of_cameroon.jpg',
	description: "Cameroon Arabica coffee is best known for its rich, full body and mellow taste along with a very pleasant aroma.",
...
const Rwanda = new Coffee({
	...
	description: "Rwanda coffee is often quite delicate tasting with a pleasant sweet, caramelly aroma and hints of citrus (lemon, orange). In general Rwanda coffees are more highly reviewed than the neighbouring regions of Zimbabwe and Zambia Coffees though not yet achieving the recognition of Kenya and Tanzania coffees. Rwanda also produces Fair Trade Coffees.",
...
const India = new Coffee({
	...
	description: "Resting of Indian coffee may go on for as long as three years and results in a strengthening of the coffee’s sweetness, often creating intense woody and loamy sensations – and a weakening of the acidity.",
...
const PapuaNewGuinea = new Coffee({
	...
	imgUrl: 'https://images.cafeimports.com/23972-papuanewguineacountrypagemap.png',
	description: "A good New Guinea coffee, such as Arona or Sigri, has a modest, low-toned richness, sometimes earthy, along with a low to moderate acidity. It is deeply dimensioned yet well-balanced, with mild and mellow yet broad flavors that provide a bright and clean taste – a classic, delicate sweetness complemented by an exotic, complex and fruity aroma.",
